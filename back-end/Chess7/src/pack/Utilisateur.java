...
public class Utilisateur implements Serializable {
	...
	@OneToMany(mappedBy="createurTournoi")
	Set<Tournoi> TournoiCree; 
	
	@ManyToMany(mappedBy="listeJoueurs",fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	Set<SousEquipe> sousEquipes;
	...
	public Set<Tournoi> getTournoiCree() {
		return TournoiCree;
	}
	public void setTournoiCree(Set<Tournoi> tournoiCree) {
		TournoiCree = tournoiCree;
	}
	public Set<SousEquipe> getSousEquipes() {
		return sousEquipes;
	}
	public void setSousEquipes(Set<SousEquipe> sousEquipes) {
